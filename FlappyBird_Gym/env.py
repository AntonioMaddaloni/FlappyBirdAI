...
class FlappyBirdEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if (self.grumpy.rect.centery - gap_center_y) < -45 and action == 1 and reward == 0:
            reward = -0.1
        elif (self.grumpy.rect.centery - gap_center_y) < -45 and action == 0 and reward == 0:
            reward = 0.1
        elif (self.grumpy.rect.centery - gap_center_y) > 45 and action == 0 and reward == 0:
            reward = -0.1
        elif (self.grumpy.rect.centery - gap_center_y) > 45 and action == 1 and reward == 0:
            reward = 0.1
        elif ((self.grumpy.rect.centery - gap_center_y) < 45  and (self.grumpy.rect.centery - gap_center_y) > -45) and reward == 0:
            reward = 0.2
